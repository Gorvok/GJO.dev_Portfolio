    ...
    return (
        <section className="relative min-h-screen flex items-center px-4 md:px-10 py-20 overflow-hidden">
            ...
            <div className="absolute inset-0 -z-10">
                ...
                <div className="absolute bottom-20 right-10 w-96 h-96 bg-sky-500/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
            ...
            <div className="max-w-7xl mx-auto w-full">
                <div className="grid gap-12 lg:grid-cols-[1.4fr_1fr] items-center">
                    ...
                    <div className="text-center lg:text-left space-y-6">
                        {/* Top badge */}
                        <div className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-green-500/10 via-sky-500/10 to-purple-500/10
                                      px-5 py-2 ring-1 ring-white/10 backdrop-blur-sm">
                            <div className="flex gap-1">
                                <div className="h-2 w-2 rounded-full bg-green-500 animate-pulse" />
                                <div className="h-2 w-2 rounded-full bg-sky-500 animate-pulse" style={{ animationDelay: '0.2s' }} />
                        ...
                        <div>
                            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-white leading-[1.1] mb-3">
                                ...
                                <span
                                    ...
                                    className="waveEmoji inline-block origin-[70%_70%] hover:animate-wave"
                                >
                                    👋
                                </span>
                        ...
                        <p className="text-base md:text-lg text-white/60 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                            <span className="text-white/80 font-medium">gjo.dev</span> is the home base for everything I create:
                            apps, tools, and digital experiences across web and mobile platforms.
                        </p>

                        {/* Focus section with typewriter */}
                        <div className="relative rounded-2xl bg-gradient-to-r from-white/[0.07] to-white/[0.03]
                                      px-6 py-5 ring-1 ring-white/10 backdrop-blur-sm max-w-2xl mx-auto lg:mx-0">
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="gradient-text hover:gradient-animate text-lg sm:text-xl md:text-2xl font-semibold">
                                        <Typewriter
                                            strings={[
                    ...
                    <div className="w-full flex justify-center lg:justify-end">
                        <div className="relative group max-w-md w-full">
                            ...
                            {/* Card */}
                            <div className="relative rounded-3xl bg-gradient-to-br from-white/[0.08] to-white/[0.02]
                                          px-8 py-10 md:px-10 md:py-12 ring-1 ring-white/10 backdrop-blur-xl
                                          shadow-2xl shadow-black/50 group-hover:ring-white/20 transition-all duration-300">

                                {/* Animated border gradient */}
                                <div className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                                     style={{
                                         background: 'linear-gradient(135deg, rgba(34,197,94,0.1), rgba(56,189,248,0.1), rgba(168,85,247,0.1))',
                                     }} />

                                <div className="relative flex flex-col items-center text-center space-y-4">
                                    {/* Logo with enhanced glow */}
                                    <div className="relative">
                                        <div className="absolute inset-0 blur-3xl bg-gradient-to-r from-green-500 via-sky-500 to-purple-500
                                                      opacity-40 group-hover:opacity-60 transition-opacity duration-500 scale-110" />
                                        <img
                                            src={LogoUrl}
                                            alt="GJO Logo"
                                            className="relative w-32 md:w-40 lg:w-44 mb-2 drop-shadow-2xl
                                    ...
                                    {/* Title */}
                                    <h3 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-white via-white to-white/70
                                    ...
                                    <p className="text-sm md:text-base text-white/60 leading-relaxed max-w-xs">
                                        One developer, many products. <span className="text-white/80 font-medium">gjo.dev</span> is
                                        the umbrella for everything I&apos;m building.
                                    </p>
