    ...
    return (
        <section className="relative px-4 pb-20 pt-8 overflow-hidden">
            ...
            <div className="absolute inset-0 -z-10">
                <div className="absolute top-20 right-10 w-72 h-72 bg-sky-500/10 rounded-full blur-3xl animate-pulse-glow" />
                <div className="absolute bottom-20 left-10 w-96 h-96 bg-green-500/10 rounded-full blur-3xl animate-pulse-glow" style={{ animationDelay: '1s' }} />
            </div>
                ...
                <header className="mb-10 md:mb-12">
                  ...
                  GJO Studio
                            ...
                            <p className="text-base md:text-lg text-white/60 max-w-2xl leading-relaxed">
                                One builder, multiple products. I run a small studio focused on education, tooling,
                                and long-term, maintainable systems that make a difference.
                            </p>
                        </div>
                        ...
                        <div className="col-span-full rounded-2xl bg-gradient-to-br from-white/[0.05] to-white/[0.02]
                          ring-1 ring-white/10 p-8 text-center">
                            ...
                            <p className="text-sm text-white/60">
                                Add ventures in{' '}
                                <code className="px-2 py-1 rounded bg-white/5 text-sky-400 font-mono text-xs">
                                    data/ventures.ts
                                </code>{' '}
