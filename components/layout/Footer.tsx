...
function SocialLinkComponent({ name, href, Icon }: SocialLink) {
    return (
        <a
            href={href}
            target="_blank"
            ...
            title={name}
            className="group relative inline-flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-white/[0.08] to-white/[0.02] ring-1 ring-white/10 hover:from-white/[0.15] hover:to-white/[0.08] hover:ring-sky-400/50 hover:scale-110 transition-all duration-300"
        >
            {/* Glow effect on hover */}
            <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-green-500/0 via-sky-500/0 to-purple-500/0 group-hover:from-green-500/20 group-hover:via-sky-500/20 group-hover:to-purple-500/20 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10" />
    ...
    return (
        <footer className="relative mt-20 bg-gray-950 text-white overflow-hidden">
            ...
            <div className="absolute inset-0 -z-10">
                <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-green-500/5 rounded-full blur-3xl animate-pulse-glow" />
                <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-sky-500/5 rounded-full blur-3xl animate-pulse-glow" style={{ animationDelay: '1.5s' }} />
            </div>
            ...
            <div className="relative h-[2px] w-full overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-sky-500/60 to-transparent animate-pulse-glow" />
            </div>
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-16">
                ...
                <div className="grid gap-10 md:gap-12 lg:grid-cols-12 items-start mb-12">
                    ...
                    <div className="lg:col-span-5 flex flex-col items-center md:items-start text-center md:text-left">
                        <Link href="/" aria-label="Go to home" className="group inline-flex items-center mb-4">
                            <div className="relative">
                                {/* Glow effect behind logo */}
                                <div className="absolute inset-0 blur-2xl bg-gradient-to-r from-green-500/20 via-sky-500/20 to-purple-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                                <Image
                        ...
                        <p className="text-sm md:text-base text-white/70 leading-relaxed max-w-md mb-6">
                            <span className="font-semibold text-white/90">GJO Studio</span> · the home base for
                            the apps, tools, and platforms I&apos;m building across web, mobile, and AI.
                        </p>
                    ...
                    <div className="lg:col-span-4 text-center md:text-left">
                        ...
                        <a
                            ...
                            className="group inline-flex items-center gap-2 mb-4 px-4 py-2 rounded-xl bg-gradient-to-r from-white/5 to-white/[0.02] ring-1 ring-white/10 hover:from-white/10 hover:to-white/5 hover:ring-sky-400/50 transition-all duration-300"
                        >
                            <svg
                                className="w-4 h-4 text-sky-400"
                                fill="none"
                            ...
                            <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-sky-400 group-hover:from-green-300 group-hover:to-sky-300 font-medium transition-all duration-300">
                hello@gjo.dev
              </span>
                        </a>
                        ...
                        <div className="flex flex-wrap justify-center md:justify-start gap-2.5 mt-4">
                            {socials.map((social) => (
                                <SocialLinkComponent key={social.name} {...social} />
                            ))}
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col-reverse sm:flex-row items-center justify-between gap-4">
                    ...
                    <button
                        onClick={scrollToTop}
                        className="group inline-flex items-center gap-2 rounded-xl px-4 py-2 ring-1 ring-white/10 hover:ring-white/30 bg-white/5 hover:bg-white/10 text-sm text-white/70 hover:text-white transition-all duration-300 hover:scale-105"
